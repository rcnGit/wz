...
export default {
    ...
    data:function(){
        return{
            ...
            centerList:'',
            centerListZ1:[{'centerName':'直属体验中心','groupId':''},{'centerName':'杭州一部体验中心','groupId':''},{'centerName':'杭州二部体验中心','groupId':''}],
            centerListZ2:[{'centerName':'金华体验中心','groupId':''}],
            centerListZ3:[{'centerName':'宁波三部体验中心','groupId':''},{'centerName':'宁波四部体验中心','groupId':''}],
            centerListZ4:[{'centerName':' 温州一部体验中心','groupId':''},{'centerName':' 温州二部体验中心','groupId':''}],
            centerListZ5:[{'centerName':'义乌体验中心','groupId':''}],
            centerListX1:[{'centerName':'成都一部体验中心','groupId':''},{'centerName':'成都二部体验中心','groupId':''},{'centerName':'成都三部体验中心','groupId':''}],
            centerListX2:[{'centerName':'贵阳体验中心','groupId':''}],
            centerListX3:[{'centerName':' 昆明一部体验中心','groupId':''},{'centerName':'昆明二部体验中心','groupId':''}],
            centerListX4:[{'centerName':' 南宁体验中心','groupId':''}],
            centerListX5:[{'centerName':'玉溪体验中心','groupId':''}],
            centerListX6:[{'centerName':'重庆一部体验中心','groupId':''},{'centerName':'重庆二部体验中心','groupId':''}],
        }
    },
    methods:{
