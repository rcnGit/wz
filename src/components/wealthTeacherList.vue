            ...
            .then(function(res) {//成功之后
                ...
                if(retCode == 0){
                    if(data.centerList.length>0){
                        ...
                        _czc.push(['_trackEvent', '体验中心财富师' ,'H5DepartFinancialPlanners','all']);//体验中心财富师
                        _czc.push(['_trackEvent', that.centerName+'体验中心财富师' ,'H5DepartFinancialPlanners',that.centerName]);//体验中心财富师
                    }
